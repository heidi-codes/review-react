...
class App extends React.Component {
  ...
  getSteps() {
    return [
      { title: "Verify Mail", path: "/wizard/step/1", component: Step1 },
      { title: "Create an Account", path: "/wizard/step/2", component: Step2 },
      { title: "Complete", path: "/wizard/step/3", component: Step3 }
    ];
  }
  renderComponent = () => {
